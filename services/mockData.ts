...
export const mockPhases: Phase[] = [
  ...
  },
  {
    ...
    exercises: [
      { id: 'f8e1', title: '5v5 Full Scrimmage', category: 'Taktik', overview: { setup: "Fullplan", action: "Matchspel enligt regler", coachingPoint: "Tillämpa fas 1-7" }, pedagogy: { what: "Spelförståelse", how: "Kommunicera och rör bollen", why: "Erfarenhet under press" }, criteria: ['Samspel', 'Defensiv intensitet', 'Beslut'], videoUrl: 'https://www.youtube.com/watch?v=uUshU-x_w7I', instructions: { warmup: "", main: "", conclusion: "" }, diagramPrompt: 'Scrimmage' },
      { id: 'f8e2', title: 'Baseline Out of Bounds (BLOB)', category: 'Taktik', overview: { setup: "Under korgen", action: "Satta spel för enkla poäng", coachingPoint: "Timing i skärmar" }, pedagogy: { what: "Inkast-taktik", how: "Följ mönstret", why: "Enkla 2 poäng varje match" }, criteria: ['Timing', 'Skärmkvalitet', 'Passningssäkerhet'], videoUrl: 'https://www.youtube.com/watch?v=vI3zZ7qK_zI', instructions: { warmup: "", main: "", conclusion: "" }, diagramPrompt: 'BLOB play' },
      { id: 'f8e3', title: 'Sideline Out of Bounds (SLOB)', category: 'Taktik', overview: { setup: "Sidlinjen", action: "Få in bollen säkert", coachingPoint: "Möt passningen" }, pedagogy: { what: "Anfallstart", how: "V-cut sen hämta bollen", why: "Undvika turnovers på inkast" }, criteria: ['V-cut', 'Target hands', 'Säkerhet'], videoUrl: 'https://www.youtube.com/watch?v=vI3zZ7qK_zI', instructions: { warmup: "", main: "", conclusion: "" }, diagramPrompt: 'SLOB play' },
      ...
      { id: 'f8fys2', title: 'Active Recovery Flow', category: 'Fysik', overview: { setup: "Fri yta", action: "Yoga-liknande stretch", coachingPoint: "Långa andetag" }, pedagogy: { what: "Återhämtning", how: "Mjuka rörelser", why: "Förhindra stelhet efter säsong" }, criteria: ['Lugn', 'Rörlighet', 'Andning'], videoUrl: 'https://www.youtube.com/watch?v=f-S89Bq68L0', instructions: { warmup: "", main: "", conclusion: "" }, diagramPrompt: 'Stretching' }
    ]
  }
];
